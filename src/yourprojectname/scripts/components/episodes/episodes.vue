<template>
  <div class="container">
    <header class="section-header" tabindex="0">
      <div class="pixel"></div>
      <span class="title-shadow">Episodes</span>
      <h1 class="title-section">Last Episodes</h1>
    </header>
    <nav >
      <ul class="tabs">
        <li
          ...
          :key="index"
          v-on:click="filterEpisodes(category.value)"
    ...
    <div class="episodes">
      <article class="card" tabindex="0" v-for="(episode, index) in filteredEpisodes" :key="index" >
